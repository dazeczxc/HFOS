...
if($_POST['query'] != '')
{
  ...
  RoomID IN (SELECT RoomID FROM rooms WHERE RoomType IN (SELECT roomtypeid FROM roomtype WHERE roomtype LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" ))
 ...
 //|| YEARWEEK(TransactionDate) = YEARWEEK('.$_POST['query'].')
...
<tbody>
<tr  class="bg-info text-gray-100 " style="position: sticky; top: 0; z-index: 1;" >
