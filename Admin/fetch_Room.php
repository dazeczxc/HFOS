...
if($_POST['query'] != '')
{
  ...
  roomnumber LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" ||
  RoomDescription LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" ||
  RoomType LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"  
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    foreach($resultss as $row_roomType){
    }
    ...
    <tr>
      <td class="d-none room_id">'.$row["RoomID"].'</td>
      <td class="py-2" style="width: 110px;">'.$row["RoomNumber"].'</td>
      <td class="py-2" style="width: 130px;">'.$row_roomType["roomtype"].'</td>

      <td class="py-2">'.$row_roomType["roomtypedescription"].'</td>
       <td class="py-2" style="width: 140px;"><img src="../Upload/'.$row["RoomImage"].'" alt="image" width="100px;" height="70px;"></td>

      <td class="d-none">'.$row_roomType["roomtypeid"].'</td>
