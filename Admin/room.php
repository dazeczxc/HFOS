        ...
        <div class="">
            <div>
                <div class="d-flex justify-content-lg-between align-items-lg-baseline border-bottom-success px-4 pt-3">
                    <p style="font-size: 1.4rem;" class="w3-left w3-text-teal"><b>Room Management</b></p>
                ...
                <div class="px-3 py-3">
                    <?php
                    if (isset($_SESSION['RoomMessage'])) {
                        echo $_SESSION['RoomMessage'];
                        unset($_SESSION['RoomMessage']);
                    }
                            ...
                            <div class="modal-body px-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="RoomType" class="form-select ">
                                        ...
                                        <?php include('roomtypedropdown.php'); ?>
                                    </select>
                                </div>
                                ...
                                <input type="hidden" name="RoomStatus" value="Vacant">
            ...
            <div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="editmodal" aria-hidden="true">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <form action="../Includes/server.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="RoomID" id="room_delete_id">
                            ...
                            <div class="pb-4 w3-center">
                                ...
                                <button type="submit" name="del" class="btn btn-success px-5">Confirm</button>
                            </div>
                        </form>
