...
if (isset($_POST["guest_ID"])) {
    ...
    while ($row_transact = mysqli_fetch_array($run_query_transact)) {
        ...
        $output .= '
                ...
                <tr >
                    ...
                    <td align="right"  class="pt-3"><span>&#8369 </span>' . $row_transact["TotalRates"] . '.00</td>
    ...
    $output .= '
                <tr class="table-borderless">
                    ...
                    <td align="right"  class="pt-3"><span>&#8369 </span>' . $row_sum['Total_Amount'] . '.00</td>
                </tr>
                </table>
