...
$query = "
SELECT * FROM rooms WHERE RoomType IN(SELECT roomtypeid FROM roomtype)
";

if($_POST['query'] != '')
{
  $query .= '
  AND RoomType IN(SELECT roomtypeid FROM roomtype WHERE roomtype LIKE "%'.str_replace(' ', '%', $_POST['query']).'%")
