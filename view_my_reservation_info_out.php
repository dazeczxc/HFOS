<?php  
 ...
 { 
    ...
    //reservation query
    $query_reservation = "SELECT * FROM recent_transaction WHERE TransactionCode = '$trans_code'";  
                ...
                <div>
                    <table class="table">
                        ...
                        <tr class="table-sm table-borderless">
                            ...
                            <td  align="right "  style="font-size: 1.2rem; "><span>&#8369 </span>' . $totalRates . '.00</td>
                        </tr>
