      ...
      <table class="table w3-center">
        ...
        <table class="table w3-center">
            ...
            <tr>
                ...
                if(!empty($result_reservation['Requests'])){
                    ...
                    <tr>
                            <td>Additional guest request: <span class="text-gray-800 ">'.$result_reservation['Requests'].'</span></td>
                        ...
                        if(!empty($result_reservation['Reply'])){
                            $output .= ' <tr>
                            <td>My Reply: <span class="text-gray-800 ">'.$result_reservation['Reply'].'</span></td>
        ...
        <div class="pt-2 ">
            <div class="d-flex justify-content-between ">
                <div class="col ">';
                if($result_reservation['Accommodationtype'] == "Reservation"){
                    $output .= ' ';
                }else{
                    if(!empty($result_reservation['Requests']) && empty($result_reservation['Reply'])){
                        $output    .=    '
    
                        <form action="#" method="POST">
                            <div class="d-flex justify-content-bottom">
                                <div class="col-md-8 mb-3">
                                    <textarea name="reply" class="form-control" placeholder="Comment"></textarea>
    
                                </div>
                                <div>
                                    <input type="hidden" name="tcode" value="'.$trans_code.'"  >
